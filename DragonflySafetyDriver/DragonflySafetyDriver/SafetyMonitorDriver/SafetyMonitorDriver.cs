...
//
// ASCOM SafetyMonitor driver for LunaticoDragonfly
//
...
namespace ASCOM.LunaticoDragonfly.SafetyMonitor
{
    ...
    //
    // Your driver's DeviceID is ASCOM.LunaticoDragonfly.SafetyMonitor
    //
    // The COM Guid attribute sets the CLSID for ASCOM.LunaticoDragonfly.SafetyMonitor
    // The COM ClassInterface/None attribute prevents an empty interface called _LunaticoDragonfly from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("6273a0b3-5cf6-4409-87ea-2379c44d2d29")]
    [ProgId("ASCOM.LunaticoDragonfly.SafetyMonitor")]
    [ServedClassName("ASCOM SafetyMonitor Driver for LunaticoDragonfly")] // Driver description that appears in the Chooser, customise as required
    ...
    public class SafetyMonitor : ReferenceCountedObjectBase, ISafetyMonitor, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LunaticoDragonfly"/> class. Must be public to successfully register for COM.
        /// </summary>
        public SafetyMonitor()
        {
            try
            {
                ...
                tl = new TraceLogger("", "LunaticoDragonfly.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
